...
#define MAVLINK_IKARUS_MESSAGES_XML_HASH 1354536216739937346
...
#define MAVLINK_MESSAGE_CRCS {{0, 50, 9, 9, 0, 0, 0}, {91, 63, 42, 42, 0, 0, 0}, {93, 47, 81, 81, 0, 0, 0}, {107, 108, 64, 65, 0, 0, 0}, {113, 124, 36, 39, 0, 0, 0}, {116, 253, 20, 20, 0, 0, 0}, {117, 17, 12, 12, 0, 0, 0}, {118, 78, 24, 24, 0, 0, 0}, {119, 6, 34, 34, 0, 0, 0}, {120, 222, 12, 12, 0, 0, 0}, {121, 213, 25, 25, 0, 0, 0}, {122, 154, 28, 28, 0, 0, 0}, {123, 52, 9, 9, 0, 0, 0}, {124, 152, 2, 2, 0, 0, 0}, {125, 142, 2, 2, 0, 0, 0}, {126, 103, 28, 28, 0, 0, 0}}
#endif
...
#include "./mavlink_msg_target_pos_vel.h"
#include "./mavlink_msg_pos_vel.h"
#include "./mavlink_msg_optical_flow.h"
#include "./mavlink_msg_range_finder.h"
#include "./mavlink_msg_cpu_usage.h"
...
# define MAVLINK_MESSAGE_INFO {MAVLINK_MESSAGE_INFO_HEARTBEAT, MAVLINK_MESSAGE_INFO_HIL_CONTROLS, MAVLINK_MESSAGE_INFO_HIL_ACTUATOR_CONTROLS, MAVLINK_MESSAGE_INFO_HIL_SENSOR, MAVLINK_MESSAGE_INFO_HIL_GPS, MAVLINK_MESSAGE_INFO_IMU, MAVLINK_MESSAGE_INFO_ATTITUDE, MAVLINK_MESSAGE_INFO_TARGET_ATTITUDE, MAVLINK_MESSAGE_INFO_GNSS, MAVLINK_MESSAGE_INFO_BAROMETER, MAVLINK_MESSAGE_INFO_TARGET_POS_VEL, MAVLINK_MESSAGE_INFO_POS_VEL, MAVLINK_MESSAGE_INFO_OPTICAL_FLOW, MAVLINK_MESSAGE_INFO_RANGE_FINDER, MAVLINK_MESSAGE_INFO_CPU_USAGE, MAVLINK_MESSAGE_INFO_RC_CHANNELS}
# define MAVLINK_MESSAGE_NAMES {{ "ATTITUDE", 117 }, { "BAROMETER", 120 }, { "CPU_USAGE", 125 }, { "GNSS", 119 }, { "HEARTBEAT", 0 }, { "HIL_ACTUATOR_CONTROLS", 93 }, { "HIL_CONTROLS", 91 }, { "HIL_GPS", 113 }, { "HIL_SENSOR", 107 }, { "IMU", 116 }, { "OPTICAL_FLOW", 123 }, { "POS_VEL", 122 }, { "RANGE_FINDER", 124 }, { "RC_CHANNELS", 126 }, { "TARGET_ATTITUDE", 118 }, { "TARGET_POS_VEL", 121 }}
